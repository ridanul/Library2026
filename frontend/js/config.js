...
// ---------------------------------------------------------------------------
window.LIB_CONFIG = {
  API_BASE: window.location.protocol === "file:" ? "http://localhost:8000/api" : "https://library.ridanul.tech/api",  DEMO_MODE_FALLBACK: false, // Set to false to catch API errors for debugging
  ENDPOINTS: {
