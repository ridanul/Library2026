...
var Api = (() => {
  ...
  return {
    ...
    getMyBorrows: () => request("/borrows/me"),
    ...
    getBorrowRequests: () => request("/admin/borrow-requests"),
    getAdminBorrows: () => request("/admin/borrows"),
    approveBorrowRequest: (requestId) => request(`/admin/borrow-requests/${requestId}/approve`, { method: "POST", body: {} }),
    rejectBorrowRequest: (requestId) => request(`/admin/borrow-requests/${requestId}/reject`, { method: "POST", body: {} }),
